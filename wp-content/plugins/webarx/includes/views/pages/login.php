...
<form class="webarx-form-wrapp" method="post" action="<?php echo $form_action; ?>">
    ...
    <input type="hidden" value="webarx_login_settings_group" name="option_page">
    <?php
        do_settings_sections('webarx_login_settings');
        settings_fields('webarx_login_settings_group');
