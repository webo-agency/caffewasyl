...
<form class="webarx-form-wrapp" method="post" action="<?php echo $form_action; ?>">
    ...
    <input type="hidden" value="webarx_firewall_settings_group" name="option_page">
    <?php
        do_settings_sections('webarx_firewall_settings');
        settings_fields('webarx_firewall_settings_group');
