...
<form class="webarx-form-wrapp" method="post" action="<?php echo $form_action; ?>">
    ...
    <input type="hidden" value="webarx_scanblock_settings_group" name="option_page">
    <?php
        do_settings_sections('webarx_hardening_settings');
        settings_fields('webarx_hardening_settings_group');
