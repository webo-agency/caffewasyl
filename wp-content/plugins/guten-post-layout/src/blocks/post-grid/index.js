...
registerBlockType( 'guten-post-layout/post-grid', {
    ...
    description: <a href='https://gutendev.com/downloads/guten-post-layout-pro/' target="_blank" className={'gpl-update-pro'}><img src={'../wp-content/plugins/guten-post-layout/src/assets/img/upgrade-pro.png'}/></a>,
